...
func startHTTPServer() {
	...
	r.Post("/api/students/bulk/csv", handlers.BulkCreateStudentsFromCSV)
	...
	log.Println("  - Students Bulk (JSON): /api/students/bulk")
	log.Println("  - Students Bulk (CSV): /api/students/bulk/csv")
